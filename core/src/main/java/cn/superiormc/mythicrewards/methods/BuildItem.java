    ...
    public static ItemStack editItemStack(ItemStack item,
        ...
        if (materialKey != null) {
            ...
            if (pluginName != null && itemID != null) {
                ...
                item = MythicRewards.methodUtil.getItemObject(itemThing);
            }
        }
        ...
        if (!lores.isEmpty()) {
            MythicRewards.methodUtil.setItemLore(meta, CommonUtil.modifyList(player, lores, args), player);
        }
        ...
        if (meta instanceof SkullMeta) {
            ...
            if (skullTextureNameKey != null) {
                ...
                if (skullTextureNameKey.length() > 16) {
                    MythicRewards.methodUtil.setSkullMeta(skullMeta, skullTextureNameKey);
                } else {
        ...
        if (meta instanceof BlockStateMeta) {
            ...
            if (state instanceof CreatureSpawner) {
                ...
                if (spawnerKey != null) {
                    ...
                    if (MythicRewards.methodUtil.methodID().equals("paper") && CommonUtil.getMinorVersion(20, 5) && entityType == EntityType.ITEM) {
        ...
        if (componentKey != null) {
            item = MythicRewards.methodUtil.editItemStack(item, player, componentKey, -1, args);
        }
