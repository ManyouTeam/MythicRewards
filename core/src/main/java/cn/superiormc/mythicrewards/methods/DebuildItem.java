...
public class DebuildItem {
    ...
    public static ConfigurationSection debuildItem(ItemStack itemStack, ConfigurationSection section) {
        ...
        if (MythicRewards.methodUtil.methodID().equals("paper") &&
            ...
            section.set("component", MythicRewards.methodUtil.serializeItemStack(itemStack));
        } else {
            ...
            if (meta.hasDisplayName()) {
                section.set("name", MythicRewards.methodUtil.getItemName(meta));
            }

            // Item Name
            if (CommonUtil.getMinorVersion(20, 5)) {
                if (meta.hasItemName()) {
                    section.set("item-name", MythicRewards.methodUtil.getItemItemName(meta));
                }
            }

            // Lore
            if (meta.hasLore()) {
                section.set("lore", MythicRewards.methodUtil.getItemLore(meta));
            }
